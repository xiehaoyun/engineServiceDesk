...
public class TPdDevicestateForm implements java.io.Serializable {
	...
	/** default constructor */
	public TPdDevicestateForm() {
	}

	/** full constructor */
	public TPdDevicestateForm(String FDevicestatename, String FDevicestatedesc,
