...
public class TPdDevexinfodict implements java.io.Serializable {
	...
	/** default constructor */
	public TPdDevexinfodict() {
	}

	/** full constructor */
	public TPdDevexinfodict(String FDevexinfoname, String FDevexinfodatatype,
