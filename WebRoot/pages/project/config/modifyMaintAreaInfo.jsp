	...
	<form id="searchEventSolutionForm"  method="post">
		<fieldset style="margin: 20px 0;">
			<legend style="text-align: left;">
				<b class="STYLE19">修改区域信息</b>
			</legend>
		<div id="tabs">
			<ul>
				<li><a href="#modifyComInfoTabs">修改公司信息</a></li>
				<li><a href="#modifyBuildingInfoTabs">修改楼宇信息</a></li>
				<li><a href="#modifyDeptInfoTabs">修改部门信息</a></li>
				<li><a href="#modifyMaintAreaInfoTabs">修改区域信息</a></li>
			</ul>
			<div id="#modifyComInfoTabs" >
			   <table style="border: 0; cellspacing: 2px; cellpadding: 5px;">
				<tr>
					<td valign="top" width="100">选择公司：</td>
					<td>
						<select id="eventSource" name="eventRequest.eventSource" class="sel00">
							<option value="-1">请选择公司</option>
							<option value="1">中鸣</option>
							<option value="2">软院</option>
						</select>
					</td>
				</tr>
				</table>
			...
			<div id="#modifyMaintAreaInfoTabs" ">
			    <table style="border: 0; cellspacing: 2px; cellpadding: 5px;">
			    <tr>
					<td width="80" class="STYLE19">关键字：</td>
					<td><input type="text" id="keywords" name="eventSolutionForm.keywords" size="25" maxlength="100"
